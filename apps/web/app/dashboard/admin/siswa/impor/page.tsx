  ...
  return (
    <div className="glass-panel max-w-2xl rounded-2xl p-6">
      ...
      <p className="mb-4 text-sm text-slate-500">
        Kolom yang dibutuhkan: <code>email, password, nis, nisn, fullName, className, gradeLevel,
        gender, birthDate</code>. Baris pertama harus berisi nama kolom ini persis.
      </p>
